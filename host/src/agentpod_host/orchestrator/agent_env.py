...
def build_agent_environment(
    *,
    ...
    env: dict[str, str] = {
        ...
        "BACKGROUND_REVIEW_MEMORY_NUDGE_TURNS": str(s.background_review_memory_nudge_turns),
        "BACKGROUND_REVIEW_SKILL_NUDGE_LOOP_ROUNDS": str(s.background_review_skill_nudge_loop_rounds),
